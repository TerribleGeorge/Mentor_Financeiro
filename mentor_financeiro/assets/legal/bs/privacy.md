# Politika privatnosti - Mentor Financeiro
...
**Politika objavljena dana:** https://terriblegeorge.github.io/Mentor_Financeiro/

Ova Politika privatnosti jasno objašnjava kojim podacima Mentor Financeiro može pristupiti, prikupljati, koristiti, pohranjivati, dijeliti i štititi. Napisano je tako da odražava trenutni rad aplikacije i treba ga čitati zajedno sa stranicom Uslovi korištenja i sigurnost.

Mentor Financeiro je aplikacija za finansijsku organizaciju, finansijsku edukaciju, ciljeve, evidenciju troškova, grafikone, izvještaje, investicione sadržaje i opcione funkcije pretplate Premium. Aplikacija nije banka, broker, finansijska institucija, registrovani investicijski savjetnik, osiguravajuće društvo ili način plaćanja.

## 1. Ko je odgovoran

Mentor Financeiro nudi programer odgovoran za objavljivanje aplikacije na Google Play.

Za ostvarivanje prava u vezi s vašim podacima, postavljanje pitanja ili zahtjev za brisanje, kontaktirajte nas putem e-pošte:
...
Ovisno o tome kako koristite aplikaciju, možemo obraditi sljedeće kategorije podataka.
...
- Informacije koje se koriste u grafikonima, izvještajima, analizama i automatskom mentorstvu unutar aplikacije.
- Profil investitora, ciljevi i odgovori dati u upitnicima ili ekranima za planiranje.

Ovi podaci mogu biti osjetljivi u praktičnom smislu, jer otkrivaju aspekte vašeg finansijskog života. Stoga trebate registrirati samo one podatke koje želite zadržati u aplikaciji.
...
- Postavke vezane za primanje obavještenja.
- Teme ili segmenti potrebni za slanje komunikacija iz same aplikacije.

Možete kontrolirati da li su obavještenja dozvoljena u postavkama Android.

### 3.6 Podaci obavještenja pročitani u Android

Nadgledanje obavještenja je opciona funkcija. Radi samo ako ručno omogućite pristup obavijestima u postavkama Android.

Kada je omogućena, aplikacija može primati naslov, tekst, naziv paketa izvorne aplikacije, vrijeme i tehničke metapodatke iz obavještenja prikazanih na vašem uređaju. Cilj je da se identifikuju obaveštenja kompatibilna sa troškovima, kupovinama, uplatama, pretplatama i transferima za generisanje finansijskih zapisa.

Važne mjere ove karakteristike:

- Aplikacija ne pristupa vašem bankovnom računu.
- Aplikacija se ne prijavljuje u banke, kartice ili digitalne novčanike.
- Aplikacija ne traži bankovnu lozinku.
- Aplikacija primjenjuje filtere da izbjegne hvatanje sigurnosnih kodova, OTP, lozinki i poruka o autentifikaciji.
- Fokus filtera je da identifikuje kompatibilne kupovine, plaćanja, poslane transfere i finansijska kretanja.
- Možete onemogućiti funkciju u aplikaciji ili opozvati dozvolu u postavkama Android.

Čak i uz filtere, obavijesti mogu sadržavati osjetljive informacije. Omogućite ovu funkciju samo ako razumijete i prihvaćate ovu vrstu obrade.

### 3.7 Lokacija

Aplikacija može zatražiti približnu ili preciznu lokaciju, u skladu s dozvolom koju je dao Android, za prilagođavanje poređenja, sadržaja ili konteksta ulaganja zemlji/regiji.

Lokacija nije potrebna za sve funkcije. Ako odbijete dozvolu, neka poređenja ili prilagođavanja mogu biti ograničena.

### 3.8 Lokalne slike i datoteke

Kada odaberete sliku za vizualno prilagođavanje aplikacije, ona se može pohraniti lokalno na uređaju. Osim ako se posebno ne implementiraju u budućnosti, ove slike za personalizaciju se ne šalju na naše servere.
...
Aplikacija može konsultovati eksterne API-je za devizne kurseve, kotacije, indekse ili informacije o tržištu. Ovi upiti obično uključuju parametre kao što su valuta, imovina, zemlja ili simbol koji se traži. Nije potrebno slati vaše registrovane lične finansijske podatke da biste dobili ove informacije.

## 4. Za šta koristimo podatke
...
- **Android sistemske usluge**: dozvole, obavještenja i resursi uređaja.

Ove treće strane mogu obraditi podatke u skladu sa svojim uslovima, politikama i postavkama.
...
Podatke čuvamo onoliko dugo koliko je potrebno za isporuku aplikacije, ispunjenje ciljeva opisanih u ovoj politici, pridržavanje zakonskih obaveza, rješavanje sporova, sprječavanje prijevara i održavanje sigurnosti.
...
Mi usvajamo razumne tehničke i organizacijske mjere za zaštitu podataka, uključujući:
...
Nijedan sistem nije 100% siguran. Također biste trebali zaštititi svoj uređaj, koristiti zaključavanje ekrana, zadržati jaku lozinku, izbjegavati dijeljenje vašeg računa i ažurirati aplikaciju kada se objavi nova verzija.
...
- Zatražite pristup, ispravku ili brisanje putem kontakt e-pošte.
...
Možemo ažurirati ovu Politiku privatnosti kako bismo odražavali promjene u aplikaciji, dobavljačima, zakonskim zahtjevima ili pravilima Google Play. Datum na vrhu označava trenutnu verziju. Relevantne promjene mogu se priopćiti unutar aplikacije, na objavljenoj stranici ili na drugi razuman način.
