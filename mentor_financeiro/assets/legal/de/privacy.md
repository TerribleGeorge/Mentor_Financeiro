# Datenschutzrichtlinie – Mentor Financeiro

**Letzte Aktualisierung:** 19. Mai 2026

**Anwendung:** Mentor Financeiro

**Paket Android:** `com.georgeguimares.mentorfinanceiro`

**Richtlinie veröffentlicht am:** https://terriblegeorge.github.io/Mentor_Financeiro/

In dieser Datenschutzrichtlinie wird klar erläutert, auf welche Daten Mentor Financeiro zugreifen, diese sammeln, verwenden, speichern, teilen und schützen kann. Es ist so verfasst, dass es den aktuellen Betrieb der Anwendung widerspiegelt, und sollte in Verbindung mit der Seite „Nutzungsbedingungen und Sicherheit“ gelesen werden.

Mentor Financeiro ist eine Anwendung für Finanzorganisation, Finanzbildung, Ziele, Spesenaufzeichnungen, Grafiken, Berichte, Anlageinhalte und optionale Premium-Abonnementfunktionen. Bei der Anwendung handelt es sich nicht um eine Bank, keinen Makler, kein Finanzinstitut, keinen registrierten Anlageberater, keine Versicherungsgesellschaft oder Zahlungsmethode.

## 1. Wer ist verantwortlich?

Mentor Financeiro wird von dem Entwickler angeboten, der für die Veröffentlichung der Anwendung auf Google Play verantwortlich ist.

Um Rechte im Zusammenhang mit Ihren Daten auszuüben, Fragen zu stellen oder die Löschung zu beantragen, kontaktieren Sie uns per E-Mail:
...
## 3. Daten, die wir möglicherweise verarbeiten

Abhängig davon, wie Sie die Anwendung nutzen, verarbeiten wir möglicherweise die folgenden Datenkategorien.
...
- Ausgaben, Ausgaben, Einnahmen, Kategorien, Finanzhistorie und Transaktionen.
- Ziele, Grenzen, Planung, finanzielle Träume und Vorlieben.
- Informationen, die in Grafiken, Berichten, Analysen und automatischem Mentoring innerhalb der App verwendet werden.
- Anlegerprofil, Ziele und Antworten in Fragebögen oder Planungsbildschirmen.

Diese Daten können in praktischer Hinsicht sensibel sein, da sie Aspekte Ihres Finanzlebens offenbaren. Daher sollten Sie in der Anwendung nur Informationen registrieren, die Sie behalten möchten.
...
Wenn Sie Benachrichtigungen von der App zulassen, können wir Folgendes verarbeiten:

- Firebase Cloud Messaging-Token (FCM).
- Einstellungen im Zusammenhang mit dem Empfang von Benachrichtigungen.
- Themen oder Segmente, die zum Senden von Mitteilungen aus der Anwendung selbst erforderlich sind.
...
Wenn diese Option aktiviert ist, kann die App den Titel, den Text, den Namen des Quell-App-Pakets, die Uhrzeit und technische Metadaten von Benachrichtigungen empfangen, die auf Ihrem Gerät angezeigt werden. Ziel ist es, Benachrichtigungen zu identifizieren, die mit Ausgaben, Käufen, Zahlungen, Abonnements und Überweisungen kompatibel sind, um Finanzunterlagen zu erstellen.

Wichtige Maßnahmen dieser Funktion:
...
Die App kann je nach der von Android erteilten Genehmigung einen ungefähren oder genauen Standort anfordern, um Vergleiche, Inhalte oder Investitionskontext an das Land/die Region anzupassen.

Der Standort ist nicht für alle Funktionen erforderlich. Wenn Sie die Erlaubnis verweigern, sind einige Vergleiche oder Anpassungen möglicherweise eingeschränkt.

### 3.8 Lokale Bilder und Dateien

Wenn Sie ein Bild auswählen, um die App optisch anzupassen, kann es lokal auf dem Gerät gespeichert werden. Sofern nicht ausdrücklich in der Zukunft implementiert, werden diese Personalisierungsbilder nicht an unsere Server gesendet.

### 3.9 Werbung

Die App kann über Google AdMob Werbung anzeigen. Google kann Gerätekennungen, Nutzungsdaten, technische Informationen und Werbesignale gemäß den eigenen Richtlinien von Google und den Anzeigeneinstellungen des Nutzers verarbeiten.

### 3.10 Daten von externen Markt-APIs

Die App kann externe APIs für Wechselkurse, Kurse, Indizes oder Marktinformationen konsultieren. Bei diesen Abfragen werden typischerweise Parameter wie Währung, Vermögenswert, Land oder Symbol gesucht. Um diese Informationen zu erhalten, ist es nicht erforderlich, Ihre registrierten persönlichen Finanzdaten zu übermitteln.

## 4. Wofür wir die Daten verwenden

Wir verwenden Daten, um:

- Erstellen und pflegen Sie Ihr Konto.
- Synchronisieren Sie Ausgaben, Ziele, Präferenzen, Verlauf und Einstellungen.
- Zeigen Sie Dashboards, Grafiken, Berichte, Grenzwerte und personalisierte Inhalte an.
- Erlauben Sie den Kauf, die Wiederherstellung und die Validierung von Premium.
...
Wir können Daten, die für den Betrieb der App erforderlich sind, an Anbieter weitergeben oder deren Verarbeitung gestatten, darunter:

- **Google Firebase**: Firebase Authentication, Cloud Firestore, Firebase Cloud Messaging, Firebase Analytics und Firebase Crashlytics.
- **Google-Anmeldung / Apple-Anmeldung**: Anmeldung über ein Drittanbieterkonto, wenn Sie dies wünschen.
- **Google Play Billing**: Bearbeitung von Abonnements, Käufen, Stornierungen, Wiederherstellung und Status von Premium.
- **Google AdMob**: Anzeige und Messung von Anzeigen.
- **Markt-, Devisen- oder Notierungs-APIs**: Abfrage öffentlicher oder marktbezogener Finanzinformationen, die in der App verwendet werden.
- **Android Systemdienste**: Berechtigungen, Benachrichtigungen und Geräteressourcen.

Diese Dritten können Daten gemäß ihren eigenen Bedingungen, Richtlinien und Einstellungen verarbeiten.

## 7. Internationale Überweisung

Dienste wie Firebase, Google Play, AdMob und andere Anbieter verarbeiten möglicherweise Daten auf Servern außerhalb Brasiliens. Durch die Nutzung der App erkennen Sie an, dass diese internationale Verarbeitung vorbehaltlich der geltenden Datenschutzbestimmungen und der Bedingungen der Anbieter erfolgen kann.
...
Wir ergreifen angemessene technische und organisatorische Maßnahmen zum Schutz der Daten, darunter:
...
Folgendes kann je nach Bedarf ausgeschlossen oder aufgehoben werden:
...
## 12. Rechte des Inhabers

Vorbehaltlich des geltenden Rechts können Sie Folgendes anfordern:

- Bestätigung des Vorliegens einer Behandlung.
- Zugriff auf Daten.
...
Die Anwendung richtet sich nicht an Kinder unter 13 Jahren. Wenn ein Erziehungsberechtigter erfährt, dass ein Kind Daten an die App übermittelt hat, sollte er sich mit uns in Verbindung setzen, damit wir die Löschung prüfen können.

## 14. Änderungen dieser Richtlinie

Wir können diese Datenschutzrichtlinie aktualisieren, um Änderungen an der App, den Anbietern, den gesetzlichen Anforderungen oder den Google Play-Regeln Rechnung zu tragen. Das Datum oben zeigt die aktuelle Version an. Relevante Änderungen können innerhalb der App, auf der veröffentlichten Seite oder auf andere angemessene Weise kommuniziert werden.
