...
- Umístění je volitelné a používá se pouze v případě, že dáte povolení, například k přizpůsobení srovnání investic zemi nebo místnímu kontextu.
...
- Můžete požádat o smazání účtu a dat prostřednictvím e-mailu uvedeného v těchto zásadách.
...
### 3.1 Účetní a identifikační údaje
...
- Nákup, zrušení, obnovení, vrácení peněz a fakturace zpracovává Google Play v souladu s pravidly účtu Google a obchodu.

Aplikace neshromažďuje ani neukládá čísla karet, bezpečnostní kódy karet ani údaje o bankovních platbách.

### 3.4 Údaje o použití, diagnostice a výkonu

- Události využití a interakce v aplikaci, například zobrazené obrazovky, použité zdroje a dokončené toky.
- Souhrnná nebo technická data k pochopení stability produktu, výkonu a zlepšení.
- Zprávy o selhání a diagnostika od Firebase Crashlytics, kde je to možné, včetně technických informací o zařízení, verze aplikace, operačního systému, protokolů chyb a identifikátoru uživatele, pokud je nakonfigurován.
...
- Aplikace nepožaduje bankovní heslo.
...
- Funkci můžete v aplikaci zakázat nebo oprávnění zrušit v nastavení Android.
...
- Odesílat oznámení ze samotné aplikace, pokud je to povoleno.
- Zpracovávejte podporovaná finanční oznámení, pokud tuto funkci povolíte.
- Když je lokalizace povolena, přizpůsobte investiční obsah místnímu kontextu.
- Zlepšete stabilitu, výkon, zabezpečení a aplikační prostředí.
- Dodržujte zákonné povinnosti, reagujte na žádosti a zabraňte zneužití.
- Zobrazujte reklamy tam, kde je to možné.

## 5. Právní základy

Když se použije LGPD, zpracování se může opírat o jeden nebo více právních základů, včetně:

- Uskutečnění smlouvy nebo předběžných postupů pro dodání aplikačních zdrojů.
- Souhlas pro volitelná oprávnění, jako je poloha, oznámení push a přístup k oznámením Android.
- Oprávněný zájem o bezpečnost, diagnostiku, zlepšování produktu, prevenci zneužívání a proporcionální statistiky.
...
- Data účtu a finanční data v cloudu zůstávají, dokud účet existuje nebo dokud není podána platná žádost o odstranění.
- Místní data mohou v zařízení zůstat, dokud aplikaci nevymažete, nevymažete nebo neodinstalujete.
- Diagnostická data, analýzy a protokoly lze uchovávat po dobu definovanou poskytovateli.
...
- Komunikace je šifrována použitými sadami SDK a rozhraními API.
- Používejte oprávnění Android pouze v souvislosti se zdroji aplikace.
- Filtruje při sledování oznámení, aby se zabránilo bezpečnostním kódům, OTP, heslům a ověřovacím zprávám.
...
- Zrušte přístup k oznámením v nastavení Android.
- Zrušte nebo spravujte předplatné prostřednictvím Google Play.
- Vymažte data místní aplikace nebo aplikaci odinstalujte.
- Požádejte o přístup, opravu nebo smazání prostřednictvím kontaktního e-mailu.

## 11. Smazání účtu a dat

Chcete-li požádat o smazání účtu a dat:

1. Pošlete e-mail na adresu **george.guimares@gmail.com**.
...
4. Uveďte, zda chcete úplné odstranění dat účtu/cloudu nebo odstranění konkrétních kategorií, je-li to technicky možné.
...
- Účet v Firebase Authentication, pokud je požadováno celkové a technicky použitelné smazání.
...
- Historie nákupů, plateb a předplatných vedená Google Play.
...
- Sdílení informací.
- Odvolání souhlasu.
- Smazání údajů zpracovávaných na základě souhlasu, je-li to relevantní.
